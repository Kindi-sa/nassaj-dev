...
**🟢 دفعة UI/إصلاحات 2026-06-10 (امتداد الشريحة) — مكتملة عدا بند جارٍ.** التفاصيل: `docs/workitems/PHASE-MU.md` (قسم الدفعة):
...
- **⏳ جارٍ:** الثيمات في Appearance (بالتوازي، لا commit بعد).
