...
**الإجمالي: 23 وكيلاً** موزّعين على ٥ فِرَق: الهندسة، التصميم، الأعمال، التسويق والمبيعات، والعابرون.
...
- **Sonnet 5** = نموذج متوسط، يكفي للعمل الروتيني والتطوير اليومي
