...
- [القاعدة الصفرية](#القاعدة-الصفرية-من-ينفّذ)
- [الوكلاء الـ22](#الوكلاء-من-هم)
- [الفِرَق والاستدعاء](#الفِرَق-والاستدعاء-الجماعي)
- [الذاكرة الدائمة](#الذاكرة-الدائمة)
- [استدعاء الوكلاء والنماذج](#آلية-استدعاء-الوكلاء-والنماذج)
- [بوابة بدء المشروع](#بوابة-بدء-المشروع-لا-كود-قبل-الخطة)
- [حدود الاستخدام](#حدود-الاستخدام-لماذا-يتوقّف-نسّاج)
- [الاجتماعات والقرارات](#الاجتماعات-والقرارات-الكبيرة)
...
فريق الوكلاء المتخصصين الـ22، منظّمون حسب التخصص. كل وكيل خبير في مجاله، والمنسّق يعرف أيّ خبير يختار لكل طلب.
...
| **backend-dev** | البنّاء | بناء APIs ومنطق الأعمال وطبقة البيانات | Sonnet 4.6 |
...
| **روتيني** | Sonnet 4.6 | frontend-dev, backend-dev, researcher, tester |
